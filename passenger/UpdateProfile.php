    ...
    <section id="container" class="">
      ...
      <section id="main-content">
        <section class="wrapper">
          <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header"><i class="fa fa-laptop"></i>Passenger Update Profile</h3>
              <ol class="breadcrumb">
                    ...
                    <div class="form quick-post">
                      ...
                      <?php 
                          ...
                          if(isset($_POST['submit']))
                          {
                              ...
                              //db query
                              $query = "UPDATE `passenger` SET id='$id', name='$name', email='$email', `contact number`= '$contact' ,dob='$dob' , location='$location' WHERE id = $id";
